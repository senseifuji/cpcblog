...
export default function EntrevistaGiselaRodriguez() {
  ...
  return (
    <Layout>
      <CpcSeo 
        title="Entrevista a Gisela Rodríguez | CPC Chihuahua"
        description="Mira la entrevista a Gisela Rodríguez, miembro del Comité de Participación Ciudadana de Chihuahua."
      />
          ...
          <Flex direction="column" alignItems="center">
            <Box width="100%" bg={red} color={white} p={8} mb={8}>
              <Text fontSize={["3xl", "4xl"]} fontWeight="bold" mb={4} fontFamily={gothamCondensed} textAlign="center">
                Entrevista a Gisela Rodríguez
              </Text>
              <Text fontSize="xl" mb={6} fontFamily={gothamCondensedBook} textAlign="center">
                Conoce más sobre Gisela Rodríguez, su trayectoria y su visión como miembro del Comité de Participación Ciudadana de Chihuahua.
              </Text>
            </Box>
            <Box width="100%" maxW="800px">
              <AspectRatio ratio={16 / 9}>
                <iframe
                  src="https://www.youtube.com/embed/vbzcQaij2Js"
                  title="Entrevista a Gisela Rodríguez"
                  allowFullScreen
                />
              </AspectRatio>
            </Box>
            <Box width="100%" mt={8}>
              <Text fontSize="xl" mb={4} fontFamily={gothamCondensed}>
                En esta entrevista, Gisela Rodríguez comparte su experiencia y perspectivas sobre:
              </Text>
