      ...
      <Layout direction="column" title="CPC Anticorrupción – En Chihuahua las personas juntas buscamos combatir la corrupción.">
          <Section bg="cpc.white" color="cpc.blackLight" desktopWidth="100%">
            <Flex direction="column" fontFamily="cpc.gothamMedium" alignItems="center" textAlign="center" px="2em">
              <Text pb={4} fontSize="2.7em" fontWeight="600"><b>Las personas <span id="changinText">{currentHomeWord}</span> la corrupción</b></Text>
              <Text fontFamily="cpc.gothamCondensed" fontSize={["19.2px"]} mb="14px">
      ...
      <Layout direction="column">
        ...
        >
          ...
          <Flex direction={["column", "column", "row", "row"]}>
            ...
            <Flex fontFamily="cpc.gothamCondensed" lineHeight="1.1em" fontSize="1.2em" direction="column" width="100%" textAlign="center" alignItems="center">
